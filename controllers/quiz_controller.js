...
// Opciones para imagienes subidas a cloudinary
var cloudinary_image_options = {crop: 'limit', width: 200, height: 200, radiius: 5,
...
exports.create = function(req, res, next) {
    ...
    .catch(function(error) {
      console.log("Error al crear el quiz");
      console.log(error);
...
function uploadResourceToCloudinary(req) {
    return new Promise(function(resolve,reject) {
        ...
        cloudinary.uploader.upload(path, function(result) {
                ...
                if (! result.error) {
                  console.log("Imagen subida a cloudinary con exito");
